...
namespace Dentist_Build
{
    public static class InitialiseData
    {
        ...
        public static void Initialise()
        {
            ...
            CentralisedRecords.SubmitNewPatient(new Patient("Shaun", "Jim", "12 Fake Street, Taunton, TA1 1NN", new DateTime(27 / 10 / 1989), 07001001002));

            //Initialise Staff Records

            CentralisedRecords.SubmitNewStaff(new Staff("Elizabeth", "Sansom", "3 Cyril Street, Taunton, TA2 6HW",
